...
class BaselineRunSpec:
    ...
    artifact_stem: str = "stage4_output_flux_spectrum"
    summary_stem: str = "stage4_run_summary"
...
def baseline_artifact_paths(
    ...
    return {
        "plot": FIGURES_DIR / f"{artifact_stem}.png",
...
def build_baseline_run_geometry(
    ...
    bus_half_length = 0.5 * geometry.bus_length_um

    source_center_x_um = -bus_half_length + run_spec.source_offset_from_bus_edge_um
    monitor_center_x_um = bus_half_length - run_spec.monitor_offset_from_bus_edge_um
    ...
    run_geometry = BaselineRunGeometry(
        ...
        monitor_size_y_um=run_spec.source_size_scale * geometry.bus_width_um,
...
def build_baseline_simulation(
    ...
    flux_monitor = simulation.add_flux(
        ...
        mp.FluxRegion(
            center=mp.Vector3(run_geometry.monitor_center_x_um, 0.0, 0.0),
...
def run_baseline_simulation(
    ...
    monitor_point = mp.Vector3(run_geometry.monitor_center_x_um, 0.0, 0.0)
    simulation.run(
