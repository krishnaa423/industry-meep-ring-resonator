...
def build_layout_geometry(
    ...
    return LayoutGeometry(
        bus_length_um=layout.bus_length_um,
...
def build_layout_library(
    ...
    ring = gdspy.Round(
        center=(geometry.ring_center_x_um, geometry.ring_center_y_um),
...
def artifact_paths() -> dict[str, Path]:
    ...
    return {
        ...
        "svg": FIGURES_DIR / "ring_resonator_layout.svg",
        "json": REPORTS_DIR / "stage2_layout_summary.json",
    }
